...
- **脑图 MVP**：**已立项并开发中（2026-09-01，[ADR-001](docs/features/mindmap/decisions/ADR-001-mindmap-mvp.md)——大纲式树形脑图先行，存储走 Rust core，Todo 双向关联；工程图 MVP 顺延独立批次）**。本地脑图、节点编辑以及与 Todo/能力的关联。AI 草稿、复杂知识整理和桌宠入口须在主干闭环稳定后验证，不做多人协作、云同步或通用白板。
